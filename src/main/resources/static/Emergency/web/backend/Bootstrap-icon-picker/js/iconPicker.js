...
(function($) {
    ...
    $.fn.iconPicker = function( options ) {
        ...
        //自定义地理类别图标数组
		//var icons = new Array("school","hospital","market", "disabled");
		var iconArray = new Array(
			{title: '学校',value: 'school'},
			{title: '医院',value: 'hospital'},
			{title: '大型商场',value: 'market'},
			{title: '残疾人员',value: 'disabled'},
			{title: '老人院',value: 'nursinghome'},
			{title: '孤寡老人',value: 'lonelyoldman'},
			{title: '特殊人群',value: 'specialpopulation'},
			{title: '小学生',value: 'primaryschool'},
			{title: '景点',value: 'scenery'});
		var settings = $.extend({
        ...
        return this.each( function() {
	        ...
	        function showList($element,arrLis){
	        	...
	        	for (var i in arrLis) {
	        		$ul.append("<li><a href=\"#\" title="+arrLis[i].title+"><span class=\"glyphicon  glyphicon-"+arrLis[i].value+"\"></span></a></li>");
	        	};
