...
var prefix = "/planManage/planAccidentType";
var editDate;
$(document).ready(function(){ 
	$('#accidentTypeTable').bootstrapTable({
		...
		columns : [{
	            ...
	            },
				{
					...
					formatter: function (value, row, index) {
	                    //获取每页显示的数量
	                    var pageSize=$('#accidentTypeTable').bootstrapTable('getOptions').pageSize;
	                    //获取当前是第几页
	                    var pageNumber=$('#accidentTypeTable').bootstrapTable('getOptions').pageNumber;
...
function reloadTable(){
	$('#accidentTypeTable').bootstrapTable('refresh');
}

function edit(id){
	var data = $('#accidentTypeTable').bootstrapTable('getRowByUniqueId',id);//行的数据
	data.dataType = "edit";
