...
$(document).ready(function () {
    $('#archiveTable').bootstrapTable({
        ...
        uniqueId: "archiveActionprogramMainId",
        ...
        columns: [{
            ...
            {
                field: 'reportObjecttype',
                title: '上报类型',
                width: 100,
                align: "center",
                formatter : function(value, row, index) {
                    if (row.reportObjecttype == '1') {
                        return "单位";
                    } else if (row.reportObjecttype == '2') {
                        return "个人";
                    }else {
                        return "";
                    }
            ...
            },
			{
				...
				formatter : function(value, row, index) {
					var html = "";
					html += '<a class="btn btn-primary btn-sm" style="margin-right: 10px;" onclick="edit(\''+row.archiveActionprogramMainId+'\')">修改</a>';
					return html ;
				}
			}]
    });
