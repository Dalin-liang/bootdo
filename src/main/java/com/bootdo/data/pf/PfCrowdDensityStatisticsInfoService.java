...
@Component
public class PfCrowdDensityStatisticsInfoService {
	
	@Autowired
	private ReceiveinfoService receiveinfoService;
	
	public void getData()  {
		System.out.println("===execute==crowdDensityStatisticsInfo==");
		String baseUrl = (String) GenUtils.getConfig().getProperty("big_data_center_baseUrl");
		String url = baseUrl+"api/pf/crowdDensityStatisticsInfo/getByBeginTime";
		System.out.println("===execute==crowdDensityStatisticsInfo==");
