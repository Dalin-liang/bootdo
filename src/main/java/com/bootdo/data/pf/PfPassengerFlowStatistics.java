...
import java.util.*;
@Component
public class PfPassengerFlowStatistics {
	@Autowired
	private ReceiveinfoService receiveinfoService;
	
	public void getData()  {
		System.out.println("===execute==passengerFlowStatistics==");
		String baseUrl = (String) GenUtils.getConfig().getProperty("big_data_center_baseUrl");
		String url = baseUrl+"api/pf/passengerFlowStatistics/getByBeginTime";
