...
@Component
public class PfCrowdDensityAlarmInfoService {
	
	@Autowired
	private ReceiveinfoService receiveinfoService;
	
	public void getData()  {
		System.out.println("===execute==crowdDensityAlarmInfo==");
		String baseUrl = (String) GenUtils.getConfig().getProperty("big_data_center_baseUrl");
		String url = baseUrl+"api/pf/crowdDensityAlarmInfo/getByBeginTime";
		System.out.println("===execute==crowdDensityAlarmInfo==");
