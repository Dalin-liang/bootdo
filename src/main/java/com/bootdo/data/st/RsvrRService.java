...
/**
 * 水库水情表:用于存储水库站测报的水库水情信息，单个测站在指定的某个整点只能有唯一的一条时段水位记录
 * 
 * @author wux
 * @email oking@163.com
 ...
 */
@Component
public class RsvrRService {
	@Autowired
	private ReceiveinfoService receiveinfoService;
	
	public void getData()  {
		System.out.println("===execute==rsvrR==");
		String baseUrl = (String) GenUtils.getConfig().getProperty("big_data_center_baseUrl");
		String url = baseUrl+"api/st/rsvrR/getByBeginTime";
