...
/**
 * 实时雨量表：用于存储测站上报的实时雨量数据，雨量数据为当前降水量，同一个测站下的指定传感器在某一个时刻只能有一条实时雨量记录
 * 
 * @author wux
 * @email oking@163.com
 * @date 2019-09-21 09:52:32
 */
@Component
public class SsylRService {
	@Autowired
	private ReceiveinfoService receiveinfoService;
	
	public void getData()  {
		System.out.println("===execute==ssylR==");
		String baseUrl = (String) GenUtils.getConfig().getProperty("big_data_center_baseUrl");
		String url = baseUrl+"api/st/ssylR/getByBeginTime";
