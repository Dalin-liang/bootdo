...
/**
 * 根据开始时间结束时间查询汽车报警详情数据
 * @author qiaodk
 */
@Component
public class CarAlarmDetailJob implements Job {

    @Autowired
    private ReceiveInfoMapper receiveInfoMapper;

    private static final Logger logger = LoggerFactory.getLogger(CarAlarmDetailJob.class);

    @Override
    public void execute(JobExecutionContext context) throws JobExecutionException {
        System.out.println("===execute==CarAlarmDetailJob==");
        String baseUrl = (String) GenUtils.getConfig().getProperty("big_data_center_baseUrl");
        String url = baseUrl+"cardata/carServiceMonitor/getDevAlarmDetail";
