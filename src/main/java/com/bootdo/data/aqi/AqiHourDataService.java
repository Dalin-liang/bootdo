...
/**
 * 定时器：根据开始时间和结束时间获取设备aqi小时数据
 * @author wux
 *
 */
@Component
public class AqiHourDataService implements Job {
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		System.out.println("===execute==AqiHourDataService==");
//		String baseUrl = (String) GenUtils.getConfig().getProperty("big_data_center_baseUrl");
//		String url = baseUrl+"/aqi/aqiHourData/getByTime";
