...
/**
 * 定时器：根据开始时间和结束时间获取设备aqi数据
 * @author wux
 *
 */
@Component
public class AqiDeviceDataService implements Job {
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		System.out.println("===execute==AqiDeviceDataService==");
//		String baseUrl = (String) GenUtils.getConfig().getProperty("big_data_center_baseUrl");
//		String url = baseUrl+"/api/aqi/aqiDeviceData/getByTime";
