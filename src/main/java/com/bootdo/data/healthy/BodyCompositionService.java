...
/**
 * 定时器：根据开始时间和结束时间获取身体成分数据
 * @author wux
 *
 */
@Component
public class BodyCompositionService implements Job {
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		System.out.println("===execute==BodyCompositionService==");
		String baseUrl = (String) GenUtils.getConfig().getProperty("big_data_center_baseUrl");
		String url = baseUrl+"api/healthy/healthyUser/getBodyComposition";
