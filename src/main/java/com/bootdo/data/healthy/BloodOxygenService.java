...
/**
 * 定时器：根据开始时间和结束时间获取血氧数据
 * @author wux
 *
 */
@Component
public class BloodOxygenService implements Job {
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		System.out.println("===execute==BloodOxygenService==");
		String baseUrl = (String) GenUtils.getConfig().getProperty("big_data_center_baseUrl");
		String url = baseUrl + "api/healthy/healthyUser/getBloodOxygen";
