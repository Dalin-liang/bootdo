...
/**
 * 定时器：根据开始时间和结束时间获取体温数据
 * @author wux
 *
 */
@Component
public class TemperatureService implements Job {
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		System.out.println("===execute==TemperatureService==");
		String baseUrl = (String) GenUtils.getConfig().getProperty("big_data_center_baseUrl");
		String url = baseUrl+"api/healthy/healthyUser/getTemperature";
