...
public class SpecialPopulationHeartRateService {
	@Autowired
	private ReceiveInfoMapper receiveInfoMapper;
	
	public void getData()  {
		System.out.println("===execute==populationHeartRate==");
		String baseUrl = (String) GenUtils.getConfig().getProperty("big_data_center_baseUrl");
		String url = baseUrl+"api/special/populationHeartRate/getByBeginTime";
		System.out.println("===execute==populationHeartRate==");
