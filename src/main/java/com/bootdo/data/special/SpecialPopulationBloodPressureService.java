...
@Component
public class SpecialPopulationBloodPressureService {
	@Autowired
	private ReceiveInfoMapper receiveInfoMapper;
	
	public void getData()  {
		System.out.println("===execute==SpecialPopulationBloodPressureService==");
		String baseUrl = (String) GenUtils.getConfig().getProperty("big_data_center_baseUrl");
		String url = baseUrl+"api/special/populationBloodPressure/getByBeginTime";
