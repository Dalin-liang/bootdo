...
public class ReceiveInfo implements Serializable {
	...
	//推送时间
	private Date ispush_time;
	//推送后的处理时间
	private Date push_handle_time;
	...
	public Date getIspush_time() {
		return ispush_time;
	}
	public void setIspush_time(Date ispush_time) {
		this.ispush_time = ispush_time;
	}
	public Date getPush_handle_time() {
		return push_handle_time;
	}
	public void setPush_handle_time(Date push_handle_time) {
		this.push_handle_time = push_handle_time;
	}
	...
	public String toString() {
		return "ReceiveInfo [id=" + id + ", repname=" + repname + ", repphone=" + repphone + ", sex=" + sex
				+ ", eventaddr=" + eventaddr + ", lat_lon=" + lat_lon + ", eventdesc=" + eventdesc + ", repdate="
				+ repdate + ", source_type=" + source_type + ", dept_id=" + dept_id + ", accident_type_id="
				+ accident_type_id + ", eventlevel=" + eventlevel + ", tempsaveFlag=" + tempsaveFlag + ", remarks="
				+ remarks + ", ispush=" + ispush + ", deptperson_id=" + deptperson_id + ", earlywarn_id=" + earlywarn_id
				+ ", is_acceptance=" + is_acceptance + ", acceptance_time=" + acceptance_time + ", acceptance_type="
				+ acceptance_type + ", examine_type=" + examine_type + ", examine_opinion=" + examine_opinion
				+ ", examiner_type=" + examiner_type + ", examine_time=" + examine_time + ", createBy=" + createBy
				+ ", createDate=" + createDate + ", updateBy=" + updateBy + ", updateDate=" + updateDate
				+ ", ispush_time=" + ispush_time + ", push_handle_time=" + push_handle_time + ", sourceMenu="
				+ sourceMenu + "]";
	}
